            ...
            [
              ...
              CarouselSlider(
                  items:[
                    Container(
                      width:double.infinity,
                      child: const Image(image: AssetImage("assets/images/carrot.jpg"),
                        fit: BoxFit.fill,),
                    ),
                    Container(
                      width:double.infinity,
                      child: const Image(image: AssetImage("assets/images/veg1.jpg"),
                        fit: BoxFit.fill,),
                    ),
                    Container(
                      width:double.infinity,
                      child: const Image(image: AssetImage("assets/images/frt1.jpg"),
                        fit: BoxFit.fill,),
                    ),
                    Container(
                      width:double.infinity,
                    ...
                    Container(
                      width:double.infinity,
                      child: const Image(image: AssetImage("assets/images/frt2.jpg"),
                        fit: BoxFit.fill,),
                    ),
                    Container(
                      width:double.infinity,
                      child: const Image(image: AssetImage("assets/images/frt3.jpg"),
                        fit: BoxFit.fill,),
                    ),
