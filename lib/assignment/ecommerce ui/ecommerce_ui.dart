                ...
                child: Center(
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        image: const DecorationImage(image: AssetImage("assets/ecommerce/cardbg1.jpg"),
                            fit: BoxFit.cover)
                    ),
                    child:Column(
                  ...
                  child:Container(
                      ...
                      child: ListView(
                          ...
                          children:[  Container(
                            ...
                            decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(20),
                              image: const DecorationImage(image: AssetImage("assets/ecommerce/smartphone.jpg"),
                                  fit: BoxFit.fill),
                            ),
                            child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  const Padding(padding: EdgeInsets.all(20),
                                    child:Text("Smart phones",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,color: Colors.black),),),
                                  const Padding(padding: EdgeInsets.all(20),
                                    child:Text("18 Brands",style: TextStyle(color: Colors.black,fontSize: 15),),),
                                ]),
                          ),
                            const Padding(padding: EdgeInsets.only(left: 10)),
                            Container(
                              ...
                              decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(20),
                                image: const DecorationImage(image: AssetImage("assets/ecommerce/fashion2.jpeg"),
                                    fit: BoxFit.fill),
                              ),
                              child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            image: const DecorationImage(image: AssetImage("assets/ecommerce/games.webp"),
                              fit: BoxFit.fill,)
                        ),
                      ),
                      const Padding(padding: EdgeInsets.only(left: 10)),
                      Container(
                        ...
                        decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(15),
                            image: const DecorationImage(image: AssetImage("assets/ecommerce/shoes.webp"),
                              fit: BoxFit.fill,)
                        ),
                      ),
                      const Padding(padding: EdgeInsets.only(left: 10)),
                      Container(
                        ...
                        decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(15),
                            image: const DecorationImage(image: AssetImage("assets/ecommerce/sports.jpg"),
                              fit: BoxFit.fill,)
                        ),
                      ),
                      const Padding(padding: EdgeInsets.only(left: 10)),
                      Container(
                        ...
                        decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(15),
                            image: const DecorationImage(image: AssetImage("assets/ecommerce/watches.webp"),
                              fit: BoxFit.fill,)
                        ),
                      ),
